...
const displayResults = () => {
    ...
    shaqQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        let percentage = (numberCorrect / shaqQuestions.length) * 100;
        resultsContainer.innerHTML = `${numberCorrect} out of ${shaqQuestions.length} questions correct which is ${percentage}%`;
    })
}
